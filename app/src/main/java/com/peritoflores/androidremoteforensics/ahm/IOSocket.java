...
public class IOSocket {
    ...
    private IOSocket() {
        try {
            ...
            String deviceID = Settings.Secure.getString(com.peritoflores.androidremoteforensics.ahm.MainService.getContextOfApplication().getContentResolver(), Settings.Secure.ANDROID_ID);
